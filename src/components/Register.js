    ...
    <>
      ...
      <form className="flex flex-col max-w-[480px] mx-auto mt-[4rem]">
        ...
        <div className="flex gap-12 items-center mb-6">
          <input  onClick={saveUser} type="submit"  value="Register"  className="px-6 py-3 bg-blue-700 cursor-pointer hover:bg-blue-600 hover:shadow-xl duration-150 font-semibold w-[max-content] rounded-lg"/>
        </div>
        <div className="flex gap-12 items-center mb-6">
          <input  type="button"  value="Test"  className="px-6 py-3 bg-blue-700 cursor-pointer hover:bg-blue-600 hover:shadow-xl duration-150 font-semibold w-[max-content] rounded-lg"/>
        </div>
