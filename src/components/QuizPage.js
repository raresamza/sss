        ...
        <>
            ...
            <div className='pr-72 pl-20 relative'>
                ...
                <div className='grid grid-cols-1 grid-rows mb-10'>
                    <textarea spellCheck={false} className='overflow-hidden bg-black  w-full rounded-t-lg decoration-none border-none outline-none h-[800px] resize-none text-white px-4 py-4'></textarea>
